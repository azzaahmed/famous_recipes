...
ActiveRecord::Schema.define(version: 20150829093451) do
  ...
  add_index "countries", ["kitchen_id"], name: "index_countries_on_kitchen_id", using: :btree

  create_table "kitchens", force: :cascade do |t|
    t.string   "kitchen_name", limit: 255
    t.boolean  "visible",                  default: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end
